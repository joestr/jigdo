/* $Id: md5sum.hh,v 1.26 2002/02/16 18:52:03 richard Exp $ -*- C++ -*-
  __   _
...
public:
  ...
  /** Tests for equality. Note: Will only return true if both message
      ...
      same. */
  inline bool operator==(const MD5Sum& md) const { return sum == md.sum; }
  inline bool operator!=(const MD5Sum& md) const { return sum != md.sum; }
  ...
  /** Deallocate buffers like finish(), but don't generate the final
      sum */
  inline MD5Sum& abort() { delete p; p = 0; return *this; }
